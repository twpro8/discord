...
from src.modules.email.infrastructure.providers.smtp_provider import SmtpEmailProvider
...
def build_email_provider(settings: Settings) -> EmailProvider:
    ...
    branch here plus a new `infrastructure/providers/*_provider.py` adapter
