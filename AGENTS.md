...
modules/<name>/
  ...
  public/
    facade.py            the module's boundary for OTHER modules: a `<Name>Facade` Protocol
                        ...
                        here — never another module's `domain/`/`usecases/`/`infrastructure/`.
  transport/http/
